        ...
        return [
          {
            ...
            declaredRegisteredTools: arrayValue(declared.registeredTools).length,
            resolvedMcp: arrayValue(resolved.mcp).length,
            resolvedSkills: arrayValue(resolved.skills).length,
            resolvedRegisteredTools: arrayValue(resolved.registeredTools).length,
        ...
        return [
          {
            ...
            sessionID: stringValue(properties.sessionID) ?? "",
            turnSnapshotId: stringValue(properties.turnSnapshotId),
            resourceType: enumValue(properties.resourceType, ["mcp", "skill", "tool"]) ?? "mcp",
            resourceID: stringValue(properties.resourceID) ?? "",
            ownerID: stringValue(properties.ownerID),
            generation: numberValue(properties.generation),
            code: stringValue(properties.code),
